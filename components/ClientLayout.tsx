...
function MobileTopBar({ onMenu }: { onMenu: () => void }) {
  // Sticky header that reserves vertical space (so no overlap)
  return (
    <div className="md:hidden sticky top-0 z-40 bg-gray-50/80 dark:bg-gray-900/80 backdrop-blur supports-[backdrop-filter]:bg-gray-50/60 border-b">
