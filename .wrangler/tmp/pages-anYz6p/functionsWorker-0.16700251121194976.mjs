...
var ALLOWED = /* @__PURE__ */ new Set([
  ...
  // your Git-connected project URL
  "https://workly-web.pages.dev",
  // legacy direct-upload project (if still used)
  "https://app.workly.app",
  // your custom domain (when active)
  "http://localhost:3000",
  "http://localhost:4173"
]);
app.use("/*", cors({
  origin: /* @__PURE__ */ __name((origin) => origin && ALLOWED.has(origin) ? origin : "", "origin"),
...
// ../.wrangler/tmp/pages-anYz6p/functionsRoutes-0.14944364174744562.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-dG8BB3/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-dG8BB3/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.16700251121194976.mjs.map
